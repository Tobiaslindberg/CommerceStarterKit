...
var OxO1493=["ondblclick","navtd","shiftKey","style"]; Window_GetElement(window,OxO1493[0x1],true)[OxO1493[0x0]]=function (){if(event[OxO1493[0x2]]){ alert(element[OxO1493[0x3]].cssText) ;} ;}  ;
</script>
