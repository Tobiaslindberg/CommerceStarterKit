...
<script runat="server">
    ...
    void Page_Init(object sender, EventArgs e)
    {
         ...
         if (this.WordDictionary == null)
         {
			 ...
			 {
			 	this.WordDictionary.DictionaryFile = "en.dic";
			 }
...
<head runat="server" id="Head1">
    <title><asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:CoreStrings, Spell_Check %>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    ...
    <script type="text/javascript">
		var OxO4da5=[]; window.focus() ;
    </script>
    <script type="text/javascript" src="Load.ashx?type=script&file=spell.js" type="text/javascript"></script>
</head>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="WIDTH: 250px">
                                            <em><asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:CoreStrings, Spell_Word_Not_In_Dictionary %>"/>:</em>
                                        </td>
                                        <td>
                                            <asp:button id="IgnoreButton" onclick="IgnoreButton_Click" runat="server" enableviewstate="False" enabled="False" cssclass="button" text="<%$ Resources:SharedStrings, Ignore %>"></asp:button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:button id="IgnoreAllButton" onclick="IgnoreAllButton_Click" runat="server" enableviewstate="False" enabled="False" cssclass="button" text="<%$ Resources:SharedStrings, Ignore_All %>"></asp:button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <em><asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:CoreStrings, Spell_Change_To %>"/>:</em>
                                        </td>
                                        <td>
                                            <p>&nbsp;</p>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:button id="AddButton" onclick="AddButton_Click" runat="server" enableviewstate="False" enabled="False" cssclass="button" text="<%$ Resources:SharedStrings, Add %>"></asp:button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <em><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:SharedStrings, Suggestions %>"/>:</em>
                                        </td>
                                        <td>
                                            <p>&nbsp;</p>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:button id="ReplaceButton" onclick="ReplaceButton_Click" runat="server" enableviewstate="False" enabled="False" cssclass="button" text="<%$ Resources:SharedStrings, Replace %>"></asp:button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:button id="ReplaceAllButton" onclick="ReplaceAllButton_Click" runat="server" enableviewstate="False" enabled="False" cssclass="button" text="<%$ Resources:SharedStrings, Replace_All %>"></asp:button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <asp:Label id="StatusText" runat="Server" forecolor="DimGray" font-size="8pt" Text="<%$ Resources:SharedStrings, Loading_Ellipsis %>"></asp:Label></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
...
<script type="text/javascript">
var OxO8f00=["isWinIE","isGecko","isSafari","isOpera","userAgent","ua","opera","safari","gecko","msie","Mac","isMac","dialogWidth","availWidth","dialogHeight","availHeight","innerWidth","innerHeight"];var _Browser_TypeInfo=null; function Browser__InitType(){if(_Browser_TypeInfo!=null){return ;} ;var Ox4={}; Ox4[OxO8f00[0x5]]=navigator[OxO8f00[0x4]].toLowerCase(),Ox4[OxO8f00[0x3]]=(Ox4[OxO8f00[0x5]].indexOf(OxO8f00[0x6])>-0x1),Ox4[OxO8f00[0x2]]=(Ox4[OxO8f00[0x5]].indexOf(OxO8f00[0x7])>-0x1),Ox4[OxO8f00[0x1]]=(!Ox4[OxO8f00[0x3]]&&!Ox4[OxO8f00[0x2]]&&Ox4[OxO8f00[0x5]].indexOf(OxO8f00[0x8])>-0x1),Ox4[OxO8f00[0x0]]=(!Ox4[OxO8f00[0x3]]&&Ox4[OxO8f00[0x5]].indexOf(OxO8f00[0x9])>-0x1) ; Ox4[OxO8f00[0xb]]=navigator[OxO8f00[0x4]].indexOf(OxO8f00[0xa])!=-0x1 ; _Browser_TypeInfo=Ox4 ;}  ; Browser__InitType() ; function Browser_IsWinIE(){return _Browser_TypeInfo[OxO8f00[0x0]];}  ;try{if(Browser_IsWinIE()){ top.moveTo((screen[OxO8f00[0xd]]-self[OxO8f00[0xc]])/0x2,(screen[OxO8f00[0xf]]-self[OxO8f00[0xe]])/0x2) ;} else { top.moveTo((screen[OxO8f00[0xd]]-self[OxO8f00[0x10]])/0x2,(screen[OxO8f00[0xf]]-self[OxO8f00[0x11]])/0x2) ;} ;} catch(x){} ;
</script>
