...
<html>
	<head>
		<title><asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedStrings, Untitled %>"/></title>
...
<html>
	<head runat="server" id="Head1">
		<title><asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:SharedStrings, Posted_Values %>"/></title>
		<style type="text/css">
	...
	<body>
		<table border="1" cellspacing="0" cellpadding="3" style="border-collapse:collapse;width:400px;">
			<tr style="color:white;background-color:steelblue">
				<td><asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:SharedStrings, Name %>"/></td>
				<td><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:SharedStrings, Value %>"/></td>
			</tr>
