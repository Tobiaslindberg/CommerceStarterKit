...
{
    public partial class CartCheckoutWorkflow : SequentialWorkflowActivity
    {
        private OrderGroup _OrderGroup;
        private bool _IsIgnoreProcessPayment;
        ...
        /// <summary>
        /// Gets or sets the indicate execute process payment or not.
        /// </summary>
        /// <value>True if not running process payment, otherwise False.</value>
        public bool IsIgnoreProcessPayment
        {
            get
            {
                return _IsIgnoreProcessPayment;
            }
            set
            {
                _IsIgnoreProcessPayment = value;
            }
        }
